...
- [Click here to go the the Assignment in Canvas](https://georgetown.instructure.com/courses/126656/assignments/570410)
- Click on the link inside the assignment to go to the acceptance page and accept the assignment. The name of the repository that will be created for you is `assignment-03-YOURGITHUBUSERNAME`:
