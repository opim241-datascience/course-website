...
- [Click here to go the the Assignment in Canvas](https://georgetown.instructure.com/courses/126656/assignments/572753)
- Click on the link inside the assignment to go to the acceptance page and accept the assignment. The name of the repository that will be created for you is `assignment-06-YOURGITHUBUSERNAME`:
...
13. Attempt to build a classification model to predict the variable you created in Exercise 10, where "Yes" is 1, and "No" is 0.
