...
- [Click here to go the the Lab in Canvas](https://georgetown.instructure.com/courses/126656/assignments/564051)
- Click on the link inside the assignment to go to the acceptance page. You should see something like the following screen, but the name of the repository that will be created is `lab-2-YOURGITHUBUSERNAME`:
...
- Open the R Markdown document `lab-02.Rmd` and Knit it.
