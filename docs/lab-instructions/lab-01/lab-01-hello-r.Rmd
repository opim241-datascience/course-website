...
subtitle: "OPIM 241 - Data Science - Spring 2021"
output: 
  tufte::tufte_html:
...
Additionally, we want to make sure everyone gets a significant amount of time at the steering wheel. In future labs you'll learn about collaborating on GitHub and produce a single lab report for your team.

# Lab Pre-Requisites

- Create a [GitHub](https://www.github.com) account if you do not already have one. The email associated with that account can be your school email or a personal email (it doesn't matter.) For simplicity, you may want to choose "Connect with Google" and use your school email address.

- Accept the invitation to [RStudio Cloud](https://rstudio.cloud) that you will have in your school email. Again, for simplicity, you may want to choose 

  * As part of the RStudio Cloud verification process, you will receive an email from `shinyapps.io` in the email you chose to assocate wit

# Accept the Lab/Assignment invitation and join the GitHub Clasroom and GitHub Organization

**You only need to join the GitHub classroom and organization the first time you accept an assignment/lab invitation. You always have to accept an assignment invitation for every lab/assignment, but GitHub classroom will already know who you are.**

- Go to the [Course in Canvas](https://georgetown.instructure.com/courses/126656)
  - Go to [Assingment](https://georgetown.instructure.com/courses/126656/assignments) and Click on _Lab 1 - Hello R!_
  - Click on the link inside the assignment to go to the acceptance page and join the classroom


# Connecting GitHub and RStudio Cloud (need to do this only one time)

**You only need to do this once, after you join the GitHub classroom/organization, so RStudio Cloud can connect to all your course repositories.** 
...
-   Back in the Authentication window, check the box for *Private repo access also enabled*, and once again, on the green box that says "Authorize rstudio" in the next window. At this point you should also make sure that the course organization shows up for you under *Organization access*. 
