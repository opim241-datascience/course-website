...
- Click on the link inside the assignment to go to the acceptance page and accept the assignment. The name of the repository that will be created for you is `assignment-04-YOURGITHUBUSERNAME`:
