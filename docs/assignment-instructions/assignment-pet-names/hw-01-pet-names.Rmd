...
This assignment assumes that you have done the Lab for Week 1.
...
For each assignment in this course you will start with a GitHub repo from GitHub classroom. The first step is always to bring these files into RStudio so that you can edit them, run them, view your results, and interpret them.
